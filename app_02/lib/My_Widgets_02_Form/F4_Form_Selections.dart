                ...
                children: [
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _gender == 'Nam' ? Colors.blue : Colors.grey,
                    ),
                    child: Text('Nam'),
                  ),
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _gender == 'Nữ' ? Colors.pink : Colors.grey,
                    ),
                    child: Text('Nữ'),
                  ),
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _gender == 'Khác' ? Colors.purple : Colors.grey,
                    ),
                    child: Text('Khác'),
                  ),
                ],
